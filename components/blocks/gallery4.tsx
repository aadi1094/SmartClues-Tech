...
const Gallery4 = ({
  ...
  description = "Explore our successful projects that have delivered exceptional results for our clients.",
  items = data,
}: Gallery4Props) => {
  ...
  return (
    <section className="py-32">
      ...
      <div className="w-full">
        ...
        >
          <CarouselContent className="ml-0 2xl:ml-[max(8rem,calc(50vw-700px))] 2xl:mr-[max(0rem,calc(50vw-700px))] flex items-center justify-start sm:justify-center">
            {items.map((item) => (
              <CarouselItem
                key={item.id}
              ...
              >
                <a href={item.href} className="group rounded-xl">
                  <div className="group relative h-full min-h-[27rem] max-w-full overflow-hidden rounded-xl md:aspect-[5/4] lg:aspect-[16/9]">
                    ...
                    />
                    <div className="absolute inset-0 h-full bg-[linear-gradient(to_bottom,transparent_0%,transparent_20%,rgba(0,0,0,0.3)_40%,rgba(0,0,0,0.8)_100%)]" />
